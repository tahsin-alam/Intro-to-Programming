...
public:
	...
	/* NOTE: "full name" for each function declared here has a "vector2::"
	 * in front of it, e.g. vector2::push_back.  You have to use the full
	 * names when you write these over in vector2.cpp */
private:
